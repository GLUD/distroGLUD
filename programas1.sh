...
#PEDIR EL DATO PARA INSTALR UN PROGRAMA DETERMINADO
read valor;
echo $((valor*valor));
#EL SIGUIENTE SWITCH CASE EVALUA EN DATO Y PROCEDE A EJECUTAR LA FUNCIÓN QUE INSTLARA EL PROGRAMA SELECCIOANDO
 case $valor in
     1)
        echo "OPCIÓN 1"
	blender;
...
#SE DA AL USUARIO LA ELECCIÓN DE INSTALAR OTRO PROGRAMA
echo "¿SI DESEA INSTALAR OTRO PROGRAMA DIGITE 1, DE LO COONTRARIO DIGITE 2"
read x
  case $x in
     1)
        echo "OPCIÓN 1"
