...
# Script que instala el tema "GLUD Logo" como nuevo tema de plymouth por dedecto.

# INFO: https://forums.linuxmint.com/viewtopic.php?t=233197

# Comando para remover el plymouth instalado con este script:
# $ sudo update-alternatives --remove default.plymouth /usr/share/plymouth/themes/glud-logo/glud-logo.plymouth

# TODO: Mejorar imagen glud-logo16.png
